// ======================================================================
// RobotBluetoth.v generated from TopDesign.cysch
// 02/25/2024 at 17:44
...
module top ;
    ...
    PWM_v3_30_2 PWM_Motores (
        ...
        .tc(Net_64),
        .trigger(1'b0));
    defparam PWM_Motores.Resolution = 8;
	...
	cy_clock_v1_0
		#(.id("27346daa-9636-46c3-8680-ce7b4809aecd"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("20000000000"),
		  .is_direct(0),
	...
	wire [0:0] tmpOE__MotorD_net;
	wire [0:0] tmpFB_0__MotorD_net;
	wire [0:0] tmpIO_0__MotorD_net;
	wire [0:0] tmpINTERRUPT_0__MotorD_net;
	electrical [0:0] tmpSIOVREF__MotorD_net;

	cy_psoc3_pins_v1_10
		#(.id("6ebfb578-9498-4202-87a8-43a5b235901e"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		MotorD
		 (.oe(tmpOE__MotorD_net),
		  .y({Net_61}),
		  .fb({tmpFB_0__MotorD_net[0:0]}),
		  .io({tmpIO_0__MotorD_net[0:0]}),
		  .siovref(tmpSIOVREF__MotorD_net),
		  .interrupt({tmpINTERRUPT_0__MotorD_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__MotorD_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__MotorI_net;
	wire [0:0] tmpFB_0__MotorI_net;
	wire [0:0] tmpIO_0__MotorI_net;
	wire [0:0] tmpINTERRUPT_0__MotorI_net;
	electrical [0:0] tmpSIOVREF__MotorI_net;

	cy_psoc3_pins_v1_10
		#(.id("46f42645-5cc8-4086-8864-2c3989744f7b"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		MotorI
		 (.oe(tmpOE__MotorI_net),
		  .y({Net_62}),
		  .fb({tmpFB_0__MotorI_net[0:0]}),
		  .io({tmpIO_0__MotorI_net[0:0]}),
		  .siovref(tmpSIOVREF__MotorI_net),
		  .interrupt({tmpINTERRUPT_0__MotorI_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__MotorI_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__M1_1_net;
	wire [0:0] tmpFB_0__M1_1_net;
	wire [0:0] tmpIO_0__M1_1_net;
	wire [0:0] tmpINTERRUPT_0__M1_1_net;
	electrical [0:0] tmpSIOVREF__M1_1_net;

	cy_psoc3_pins_v1_10
		#(.id("809a949e-3592-4d8f-aae2-d1829933ca9f"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		M1_1
		 (.oe(tmpOE__M1_1_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__M1_1_net[0:0]}),
		  .io({tmpIO_0__M1_1_net[0:0]}),
		  .siovref(tmpSIOVREF__M1_1_net),
		  .interrupt({tmpINTERRUPT_0__M1_1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__M1_1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__M1_2_net;
	wire [0:0] tmpFB_0__M1_2_net;
	wire [0:0] tmpIO_0__M1_2_net;
	wire [0:0] tmpINTERRUPT_0__M1_2_net;
	electrical [0:0] tmpSIOVREF__M1_2_net;

	cy_psoc3_pins_v1_10
		#(.id("06f896a3-e31e-40d5-8960-a754832b2d6b"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		M1_2
		 (.oe(tmpOE__M1_2_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__M1_2_net[0:0]}),
		  .io({tmpIO_0__M1_2_net[0:0]}),
		  .siovref(tmpSIOVREF__M1_2_net),
		  .interrupt({tmpINTERRUPT_0__M1_2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__M1_2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__M2_1_net;
	wire [0:0] tmpFB_0__M2_1_net;
	wire [0:0] tmpIO_0__M2_1_net;
	wire [0:0] tmpINTERRUPT_0__M2_1_net;
	electrical [0:0] tmpSIOVREF__M2_1_net;

	cy_psoc3_pins_v1_10
		#(.id("45ec572c-e183-455a-a867-4bbbb4b106f4"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		M2_1
		 (.oe(tmpOE__M2_1_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__M2_1_net[0:0]}),
		  .io({tmpIO_0__M2_1_net[0:0]}),
		  .siovref(tmpSIOVREF__M2_1_net),
		  .interrupt({tmpINTERRUPT_0__M2_1_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__M2_1_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__M2_2_net;
	wire [0:0] tmpFB_0__M2_2_net;
	wire [0:0] tmpIO_0__M2_2_net;
	wire [0:0] tmpINTERRUPT_0__M2_2_net;
	electrical [0:0] tmpSIOVREF__M2_2_net;

	cy_psoc3_pins_v1_10
		#(.id("ac415919-372c-4b9b-8912-8215f4b08540"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		...
		M2_2
		 (.oe(tmpOE__M2_2_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__M2_2_net[0:0]}),
		  .io({tmpIO_0__M2_2_net[0:0]}),
		  .siovref(tmpSIOVREF__M2_2_net),
		  .interrupt({tmpINTERRUPT_0__M2_2_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__M2_2_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
