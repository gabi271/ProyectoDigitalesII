...
void PWMisr_SetVector(cyisraddress address)
{
    ...
    ramVectorTable[CYINT_IRQ_BASE + (uint32)PWMisr__INTC_NUMBER] = address;
}
...
cyisraddress PWMisr_GetVector(void)
{
    ...
    return ramVectorTable[CYINT_IRQ_BASE + (uint32)PWMisr__INTC_NUMBER];
}
