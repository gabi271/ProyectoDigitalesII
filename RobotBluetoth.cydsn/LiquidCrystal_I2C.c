...
//Portado para PSoC por Å arÅ«nas Straigis
...
//funcion agregada por el Ing. Rubén Mansilla para mostrar de //a un caracter
void LCD_printChar(char date){
        
	write(date);
	return;	
}

//funcion agregada por el Ing. Rubén Mansilla para mostrar borrar display ya que la funcion original esta duplicada 
